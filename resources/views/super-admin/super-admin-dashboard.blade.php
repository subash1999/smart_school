...
@section("super-admin-content")
    <div class="container-fluid p-3">
        <div class="row">
            <div class="col-8 border-right border-theme">
                <div class="row">
                    {{--                Schools Tile--}}
            ...
            <div class="col-auto ml-auto">
                <div class="alert alert-purple">
                    <div class="alert-heading">
                        ...
                        <hr>
                        <img src="{{ getPassportPhotoImageUrl($super_admin->passport_photo) }}" alt="PP of {{ $super_admin->id }}"
                             height="180px" class="d-block m-auto">
                        <br>
                        <a href="{{ route('super-admin-edit-profile') }}" class="btn btn-outline-primary d-block m-auto">Edit Profile</a>
                    </div>
                    <hr>
                    ...
                    <span class="text-break">Country:
                        {{ $super_admin->country }}
                        <img src="https://www.countryflags.io/{{ countryToCountryCode($super_admin->country) }}/shiny/24.png">
                        </span>
                    <br>
